...
<div class="container">
    ...
    <form action="{{ route('meetings.update', $meeting->id) }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="date" name="start_date" id="start_date" class="form-control @error('start_date') is-invalid @enderror" value="{{ old('start_date', $meeting->start_date) }}" required>
            @error('start_date')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="date" name="end_date" id="end_date" class="form-control @error('end_date') is-invalid @enderror" value="{{ old('end_date', $meeting->end_date) }}" required>
            @error('end_date')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="mb-3">
            ...
            <textarea name="note" id="note" class="form-control @error('note') is-invalid @enderror">{{ old('note', $meeting->note) }}</textarea>
            @error('note')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="mb-3">
            ...
            <div class="form-check">
                <input class="form-check-input" type="checkbox" name="is_departure_transport_ready" id="departure_ready" value="1" {{ old('is_departure_transport_ready', $meeting->is_departure_transport_ready) ? 'checked' : '' }}>
                <label class="form-check-label" for="departure_ready">
                    Transportasi Keberangkatan Siap
                </label>
            </div>
            <div class="form-check">
                <input class="form-check-input" type="checkbox" name="is_return_transport_ready" id="return_ready" value="1" {{ old('is_return_transport_ready', $meeting->is_return_transport_ready) ? 'checked' : '' }}>
                <label class="form-check-label" for="return_ready">
                    Transportasi Kembali Siap
                </label>
            </div>
            <div class="form-check">
                <input class="form-check-input" type="checkbox" name="is_rest_place_ready" id="rest_place_ready" value="1" {{ old('is_rest_place_ready', $meeting->is_rest_place_ready) ? 'checked' : '' }}>
