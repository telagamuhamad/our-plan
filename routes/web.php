...
Route::middleware(['auth'])->group(function () {
    ...
    Route::middleware('belongs.to.couple')->group(function () {
        ...
        Route::prefix('savings-analytics')->group(function () {
            Route::get('/', [SavingsAnalyticsController::class, 'index'])->name('savings-analytics.index');
        ...
        Route::prefix('savings-comparison')->group(function () {
            Route::get('/', [SavingsComparisonController::class, 'index'])->name('savings-comparison.index');
